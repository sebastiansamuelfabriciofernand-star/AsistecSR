...
import io.github.jan.supabase.postgrest.from // 👈 CAMBIO: Importación correcta de Postgrest
...
class ListaAlumnosActivity : AppCompatActivity() {
    ...
    private fun cargarTodosLosAlumnosDeBaseDeDatos() {
        lifecycleScope.launch {
            try {
                // CORRECCIÓN: Sintaxis .from() en singular o plural según tu tabla maestra
